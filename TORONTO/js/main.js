...
const packageId = "4ef82789-e038-44ef-a478-a8f3590c3eb1";
...
const getPackage = new Promise((resolve, reject) => {
    ...
    get(`https://ckan0.cf.opendata.inter.prod-toronto.ca/api/3/action/package_show?id=${packageId}`, (response) => {
...
const getDatastoreResource = resource => new Promise((resolve, reject) => {
    ...
    get(`https://ckan0.cf.opendata.inter.prod-toronto.ca/api/3/action/datastore_search?id=${resource["id"]}`, (response) => {
